...
export const jobCategories: JobCategory[] = [
  {
    ...
    description:
      "Join prestigious international airlines as cabin crew, serving passengers on global routes with competitive salaries and travel benefits.",
    icon: Plane,
    employers: [
      "Sri Lankan (Colombo - Sri Lanka)",
      "Fits Air (Colombo- Sri Lanka)",
      "Emirates (UAE – Dubai)",
      "Etihad Airways (UAE – Abu Dhabi)",
      "Qatar Airways (Qatar – Doha)",
      "FlyDubai (UAE)",
      "Air Arabia (UAE – Sharjah)",
      "Gulf Air (Bahrain)",
      "Oman Air (Oman – Muscat)",
      "Kuwait Airways (Kuwait)",
      "Saudia / Riyadh Air (Saudi Arabia)",
  ...
  },
  {
    ...
    description:
      "Work with aviation authorities and regulatory bodies ensuring compliance with international aviation standards and safety protocols.",
    icon: Building,
    employers: [
  ...
  },
  {
    ...
    description:
      "Provide exceptional customer service at airports and airline offices, handling passenger inquiries, bookings, and support services.",
    icon: Users,
    employers: [
      "Sri Lankan Airlines",
  ...
  },
  {
    ...
    description:
      "Apply your hospitality and service skills in luxury resorts, cruise lines, and travel companies worldwide.",
    icon: MapPin,
    employers: [
      "Shangri-La Hotels",
  ...
  },
  {
    ...
    description:
      "Essential ground support services including ramp operations, cargo handling, and aircraft servicing.",
    icon: Shield,
    employers: [
  ...
  },
  {
    ...
    description:
      "Share your expertise by training the next generation of aviation professionals in training institutes and airlines.",
    icon: GraduationCap,
    employers: [
...
export const careerProgression: CareerProgression[] = [
  {
    ...
    duration: "0-2 years",
    description:
      "Start your aviation career with comprehensive training and mentorship from experienced crew members.",
    responsibilities: [
  ...
  },
  {
    ...
    duration: "2-5 years",
    description:
      "Take on leadership roles and specialized responsibilities while mentoring new crew members.",
    responsibilities: [
  ...
  },
  {
    ...
    duration: "5-8 years",
    description:
      "Lead cabin crew teams and manage in-flight operations with full responsibility for passenger experience.",
    responsibilities: [
  ...
  },
  {
    ...
    duration: "8+ years",
    description:
      "Senior management roles in airline operations, training, and strategic planning for cabin services.",
    responsibilities: [
...
export const successMetrics: SuccessMetric[] = [
  {
    ...
    value: "95%",
    description: "Within 1 year of graduation",
    icon: Globe,
  },
  {
    id: "graduates-placed",
 ...
 */
export const getCareerProgressionByLevel = (
  level: string
): CareerProgression | undefined => {
  return careerProgression.find(
    (stage) => stage.level.toLowerCase() === level.toLowerCase()
  );
};
 ...
 */
export const calculateCareerEarnings = (
  startingSalary: number,
  annualIncrease: number = 0.08,
  years: number = 20
): number => {
  let totalEarnings = 0;
