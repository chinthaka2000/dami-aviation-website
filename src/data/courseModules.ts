...
export const theoreticalModules: CourseModule[] = [
  {
    ...
    type: "theoretical",
    description:
      "Comprehensive introduction to aviation history, airline operations, and fundamental aviation concepts. This foundational module covers the evolution of aviation and essential industry knowledge.",
    duration: "1st Week",
    icon: Plane,
    topics: [
  ...
  },
  {
    ...
    type: "theoretical",
    description:
      "Understanding the cabin crew profession, responsibilities, and the essential skills required for success in the aviation industry.",
    duration: "2nd Week",
    icon: Users,
    topics: [
  ...
  },
  {
    ...
    type: "theoretical",
    description:
      "Comprehensive passenger service training covering all aspects of passenger interaction, special needs handling, and conflict resolution.",
    duration: " 3rd Week",
    icon: UserCheck,
    topics: [
  ...
  },
  {
    ...
    type: "theoretical",
    description:
      "Essential communication skills, teamwork, and leadership development for effective cabin crew performance.",
    duration: "4th Week",
    icon: MessageCircle,
    topics: [
      "Communication",
  ...
  },
  {
    ...
    type: "theoretical",
    description:
      "Comprehensive training in inflight service delivery, food and beverage operations, and creating exceptional passenger experiences.",
    duration: "5th - 6th Week",
    icon: Coffee,
    topics: [
      "Introduction",
      "Food & beverage",
  ...
  },
  {
    ...
    type: "theoretical",
    description:
      "Critical safety protocols, emergency procedures, and fire safety training essential for cabin crew operations.",
    duration: "7th Week",
    icon: Shield,
    topics: [
  ...
  },
  {
    ...
    type: "theoretical",
    description:
      "Medical emergency response, first aid procedures, and health management protocols for cabin crew.",
    duration: "8th Week",
    icon: Heart,
    topics: [
  ...
  },
  {
    ...
    type: "theoretical",
    description:
      "Comprehensive security protocols, dangerous goods regulations, and threat management in aviation.",
    duration: "9th & 10th Week",
    icon: AlertTriangle,
    topics: [
  ...
  },
  {
    ...
    type: "theoretical",
    description:
      "Professional development, job application skills, and career advancement strategies in the aviation industry.",
    duration: "11th Week",
    icon: Briefcase,
    topics: [
  ...
  },
  {
    ...
    type: "theoretical",
    description:
      "Comprehensive review and assessment of all course materials, leading to course completion certification.",
    duration: "12th Week",
    icon: GraduationCap,
    topics: [
...
export const practicalModules: CourseModule[] = [
  {
    ...
    type: "practical",
    description:
      "Comprehensive fire safety training covering theoretical knowledge and hands-on practical experience with fire extinguishers and rescue operations. Led by certified instructor Mr. Chaminda Nuragodage.",
  ...
  },
  {
    ...
    type: "practical",
    description:
      "Essential first aid and emergency medical response training conducted by Dr. Sandaruwan Liyanage & Mrs Anoma Herath. Covers comprehensive medical emergency procedures and life-saving techniques.",
    duration: "3hrs+ (Day 1)",
    icon: Heart,
    topics: [
  ...
  },
  {
    ...
    type: "practical",
    description:
      "Professional grooming and appearance training led by Miss Sithara Dilrukshi. Focus on international aviation standards for personal presentation and professional image.",
    duration: "04hrs+ hours (Day 1)",
    icon: Sparkles,
    topics: [
  ...
  },
  {
    ...
    type: "practical",
    description:
      "Comprehensive physical fitness training designed specifically for aviation professionals. Conducted by Mr.Mahesh Gunarathna, focusing on health, endurance, and physical requirements for cabin crew.",
  ...
  },
  {
    ...
    type: "practical",
    description:
      "Essential water survival skills training conducted by Mr. Mahesh Gunarathna. Comprehensive training in water safety, survival techniques, and emergency procedures for aviation professionals.",
    duration: "3.5hrs+ (Day 2)",
    icon: Waves,
    topics: [
  ...
  },
  {
    ...
    type: "practical",
    description:
      "Unlock your potential and confidently step into the world of aviation with our exclusive Cabin Crew Interview Training, meticulously designed and delivered by industry specialist Damith Isuru. This comprehensive program prepares aspiring cabin crew members to meet and exceed the rigorous standards of leading global airlines.",
    duration: "3.5hrs+",
    icon: Briefcase,
    topics: [
