...
/**
 * Testimonial data for aviation cabin crew training course
 * Contains diverse student feedback covering course quality and career outcomes
 */
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    rating: 5,
    review:
      "Today I was able to get this job really because of sir. Sir, in the previous exam too, he told me what to write and what are the questions. And so is the final interview. Everything was explained correctly, from the way to dress to the quastions. Thank you very much for all that sir.🥹🙏🏻",
    courseCompleted: "Cabin Crew Training Program",
    graduationYear: 2025,
    location: "",
  },
  ...
  },
  {
    ...
    rating: 5,
    review:
      "Sir I passed the interview🥺.. Thank You So Much for ur guidance and for everything which you have done until today.. And even the final seminar interview was also really helpful for the today's success.",
    courseCompleted: "",
    graduationYear: 2025,
  },
  {
  ...
  },
  {
    ...
    rating: 5,
    review:
      "Course එක නම් නියමයි❤ඇත්තටම වෙන කියන්න වචන නැ සර්. FB එකේ උඩට පල්ලට යද්දි සර්ගෙ post එකක් අහම්බෙන් දැකලා කතා කරලා cabin crew කෙනෙක් වෙන්න තියෙන ආසාව නිසාමයි group එකට join උනේ. පලවෙනි class දවස බලමුකො කොහොමද කියලා හිතාගෙන class එකට join වුනේ. එදා සර් හැම දෙයක් ගැනම මුලක ඉදන් කියලා දුන්නා... Thank you so much sir........🥺❤",
    courseCompleted: "",
    graduationYear: 2025,
  },
  {
    ...
    rating: 5,
    review:
      "සර් course එක නම් ඇත්තටම නියමයි. නියමයි කියන්නේ ජිවිතේ දැනගෙන හිටපු නැති දේවල් ගොඩාක් ඉගෙන ගත්තා. ඇත්තටම සර් මම මේ course එක ගැන දැන ගත්තේ ground handling තේරුන අක්ක කෙනෙක්ගෙන්. Training දවස් දෙකෙත් අපිට හොදට සැලකුවා. අපි ගැන ලොකු අවදානයක් දීලා තියෙනව කියල මට හිතුනා. සර්ට ගොඩාක් ස්තූතිය. 🫶",
    courseCompleted: "",
    graduationYear: 2025,
  },
];
...
export const getTestimonials = (
  ...
  return {
    ...
    hasMore: endIndex < testimonials.length,
