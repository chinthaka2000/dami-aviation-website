      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            Experience Our Training Excellence
          </h2>
          <p className="text-gray-300 max-w-3xl mx-auto text-lg">
            Watch our comprehensive aviation training program in action and see why DAMI Aviation
            is the premier choice for aspiring aviation professionals.
          </p>
        </div>
          ...
          <div className="bg-[#0a1929]/50 backdrop-blur-lg rounded-2xl p-6 md:p-8 border border-white/10 shadow-xl">
            <div className="relative w-full" style={{ paddingBottom: '56.25%' }}>
              <iframe
                ...
                src="https://www.youtube-nocookie.com/embed/4xo0gKXgCRo?autoplay=1&mute=1&controls=0&modestbranding=1&showinfo=0&rel=0&loop=1&playlist=4xo0gKXgCRo&disablekb=1&fs=0&iv_load_policy=3"
