...
const DamiAviationPromoSection = () => {
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            DAMI Aviation T-Shirt and Wrist Band Promo
          </h2>
          <p className="text-gray-300 max-w-3xl mx-auto text-lg">
            Discover our exclusive DAMI Aviation merchandise promotion.
          </p>
        </div>
          ...
          <div className="bg-[#0a1929] backdrop-blur-lg rounded-2xl p-6 md:p-8 border border-white/10 shadow-xl">
            <div className="relative w-full" style={{ paddingBottom: '56.25%' }}>
              <iframe
                ...
                src="https://www.youtube-nocookie.com/embed/YOUR_YOUTUBE_VIDEO_ID?autoplay=1&mute=1&controls=0&modestbranding=1&showinfo=0&rel=0&loop=1&playlist=YOUR_YOUTUBE_VIDEO_ID&disablekb=1&fs=0&iv_load_policy=3"
                title="DAMI Aviation T-Shirt and Wrist Band Promo"
                style={{ border: 'none' }}
            ...
            <div className="text-center mt-6">
              <p className="text-gray-300">
                Explore our stylish and comfortable aviation apparel.
              </p>
...
export default DamiAviationPromoSection;
